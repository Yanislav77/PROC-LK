...
| **Transactions** | 12 | загрузка таблицы, табы, кнопки экспорта, фильтры, детализация, навигация |
| **Transactions — фильтры и кнопки** | 16 | метки фильтров, значения по умолчанию, поиск, размер страницы, кнопки действий (Возврат / Вебхук / Статус), пагинация |
| **Transactions — детализация** | 5 | заголовок, секции «История / Детали / Данные», кнопка «Назад», кнопки действий |
